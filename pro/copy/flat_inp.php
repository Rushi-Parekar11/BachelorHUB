...
if(isset($_POST['submit'])){
    extract($_POST);
    $date=date("Y-m-d");
    $sql="INSERT INTO  copydb (namef,rent,addressf,contact,datef,Gender) VALUES ('$namef','$rent','$addressf','$contact','$date','$Gender')";
  ...
  //exit;
    ...
    if($result){
        ...
        echo "<script>
            alert('$message');
            window.location.href = 'flat_room_hostel.php';
        </script>";
        exit();
    } else {
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="main">
        <div class="con">
            <form action="flat_inp.php" method="post">
                <h1>Info About Proparty/Hostel</h1>
                <div class="one">
                    <input type="text" name="namef" id="passward" placeholder="Enter flat or hostel name" required>
                </div>
              ...
              <div class="three"><input type="text" name="Gender" id="passward" placeholder="Male/Female" required>
            </div>
            <div class="twooo"><input type="text" name="addressf" id="passward" placeholder="address" required>
                </div>
                <div class="five"></div>
