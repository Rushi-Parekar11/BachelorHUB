...
<head>
    ...
    <style>
        ...
        .container{
            height: auto;width:50vw;margin-left: -10px;
        }
        .card{height: 190px;width: 600px;margin-top: 27px;margin-bottom: 10px;box-shadow: 2px 1px 9px 0px;margin-left: 90px; } 
        .imgs{height: 120vh;width: 35vw;position:fixed;margin-left: 800px;margin-top: 150px;}
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href= "\php\WTP\pro\zAdmin\verifyAdmin.html">Admin</a></li>
                        </ul>
                      </li>
                     <!-- users end -->
                     <li id="tp">
...
<div class="xy"id="xyz">
                        ...
                        <ul class="dropdown-menu">
                          <li style="margin-left: -27px;" ><a class="dropdown-item"  onclick="sortprice()"> Rent-Low to High</a></li>

                          <li><hr class="dropdown-divider"></li>
                          <li style="margin-left: -27px;" ><a class="dropdown-item" onclick="sortpricetwo()"> Rent-High to Low</a></li>
                        </ul> 
  <hr>    
  </div>  
  <div class="xy"id="xyz">
  ...
  <div class="xy"id="xyz">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><hr class="dropdown-divider"></li>
                          <li><a class="dropdown-item" href= "#">VEG/NON VEG/a></li>
                        </ul> 
  <hr>    
  </div> 
  	</div>
       ...
       <?php
                if ($result->num_rows > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ?>
       <div class="card">
        <h2><?php echo $row['namefV'] ?></h2>
        <div class="h6">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
            <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/></svg>
            <?php echo $row['addressfV'] ?></div>

         <div class="rent"><strong class="ren">₹ <?php echo $row['rentV'] ?> </strong> / Month &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <strong>For</strong>/<?php echo $row['VN'] ?></div> 
         <hr class="hrr">
          <div class="contact">
            ...
            <!-- <a href="">more+</a>              -->
            <section id="dtd">UPDATED( <?php echo $row['datefV'] ?> )</section> 
          </div>
       ...
       <?php  }
        ...
        <div class="imgs">
            <div class="carousel-item active">
                <img src="slid canteen 3.jpg" class="d-block w-100" alt="mian img">
                <h1>Canteen & Mess </h1>
                <h3>For Bachlor's</h3>
            </div>
            <h1>Canteen And Mess for boys</h1>
        </div>
  ...
  function sortprice() {
    ...
    cardsArray.sort(function(a, b) {
        var aRent = parseInt(a.querySelector('.rent .ren').textContent.trim().replace('₹', '').trim());
        var bRent = parseInt(b.querySelector('.rent .ren').textContent.trim().replace('₹', '').trim());       
        return aRent - bRent;
    });
...
function sortpricetwo() {
    ...
    cardsArray.sort(function(a, b) {
        var aRent = parseInt(a.querySelector('.rent .ren').textContent.trim().replace('₹', '').trim());
        var bRent = parseInt(b.querySelector('.rent .ren').textContent.trim().replace('₹', '').trim());       
        // Sort in descending order (bRent - aRent)
        return bRent - aRent;
    });
    var container = document.querySelector('.container');
    container.innerHTML = '';
